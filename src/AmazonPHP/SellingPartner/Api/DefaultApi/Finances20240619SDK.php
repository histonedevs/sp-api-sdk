 ...
 */
final class Finances20240619SDK implements Finances20240619SDKInterface
{
    ...
    public function listTransactions(AccessToken $accessToken, string $region, \DateTimeInterface $posted_after, ?\DateTimeInterface $posted_before = null, ?string $marketplace_id = null, ?string $next_token = null) : \AmazonPHP\SellingPartner\Model\Finances20240619\ListTransactionsResponse
    {
        ...
        $this->configuration->extensions()->preRequest('Finances20240619', 'listTransactions', $request);
        ...
        try {
            ...
            if ($this->configuration->loggingEnabled('Finances20240619', 'listTransactions')) {
                $this->logger->log(
                    $this->configuration->logLevel('Finances20240619', 'listTransactions'),
                    'Amazon Selling Partner API pre request',
                    [
                        'api' => 'Finances20240619',
                        'operation' => 'listTransactions',
            ...
            $this->configuration->extensions()->postRequest('Finances20240619', 'listTransactions', $request, $response);
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonPHP\SellingPartner\Model\Finances20240619\ListTransactionsResponse',
            []
        );
    }
